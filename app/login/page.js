 ...
 * @description A professional, responsive login page for the application.
 * Features a two-panel layout for branding and the login form,
 * social login options, and a loading state for the sign-in button.
 * @version 2.0.0
 */
...
/**
 * A reusable button for social media login providers.
...
/**
 * The main component for the application's login page.
 */
export default function LoginPage() {
  ...
  /**
   * Handles the form submission, simulates an API call, and navigates to the dashboard.
        ...
        <div className="w-full max-w-md">
          ...
          <form onSubmit={handleLogin} className="mt-8 space-y-4">
            ...
            <div>
              ...
              {/* ✅ CORRECTED: Using shadcn/ui Select component structure */}
